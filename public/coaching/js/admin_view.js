var view = {
  updateView: function(){
    ...
    if(model.info.batches.length === 0 || model.info.faculties.length === 0){
      ...
      var header_options = "<div class='btn btn-group btn-group-justified' role='group' aria-label='...'><div class='btn-group' role='group'><div class='dropdown'><button type='button' class='btn btn-default drpdnbtn' onclick='view.dropdown(event)' tg='admin#new' style='padding-top:10px;padding-bottom:10px'>New <span class='caret'></span></button><div id='admin#new' class='dropdown-content'><div onclick='view.showAddBatchModal()'>Batch</div><div onclick='view.showAddFacultyModal()'>Faculty</div><div id='addNewStudent' onclick='view.batchOptions(event)'>Student</div></div></div></div><div class='btn-group' role='group'><button id='takeAttendance' type='button' class='btn btn-default' onclick='view.batchOptions(event)' style='padding-top:10px;padding-bottom:10px'>Take Attendance</button></div><div class='btn-group' role='group'><div class='dropdown'><button type='button' class='btn btn-default drpdnbtn' onclick='view.dropdown(event)' style='padding-top:10px;padding-bottom:10px' tg='admin#message'>Message <span class='caret'></span></button><div id='admin#message' class='dropdown-content'><div onclick='view.messageFaculties()'>Message Faculties</div></div></div></div><div class='btn-group' role='group'><div class='dropdown'><button type='button' class='btn btn-default drpdnbtn' onclick='view.dropdown(event)' tg='admin#options' style='padding-top:10px;padding-bottom:10px'>Options <span class='caret'></span></button><div id='admin#options' class='dropdown-content'><div id='profile' onclick='view.batchOptions(event)'>Profile</div></div></div></div></div>";
      ...
      */
          ...
          var left = "<div class='col-xs-9' style='max-height:550px;margin-top:25px;overflow-y:auto;'>" + messages + "<div class='row'><div class='col-xs-10 col-xs-offset-2' style='margin-top:25px'></div></div></div>";
  ...
  showClasses: function(){
      ...
      if(model.info.batches){
        ...
        classes.forEach(function(x,i){
            names += "<div class='col-xs-2 faculty_name text-danger' id='" + x._id + "' onclick='controller.batchSelected(event,1)' style='margin-top:15px;border:solid 1px rgba(160,160,160,.8);box-shadow:2px 2px 5px rgba(160,160,160,.4);border-radius:3px;margin-left:10px'>" + x.class + "/" + x._id.split('/')[2] + "</div>";
        })
      }
  ...
  showSelectedFacultyData: function(){
    ...
    var header_options = "<div class='btn btn-group btn-group-justified' role='group' aria-label='...' style='margin-bottom:25px'><div class='btn-group' role='group'><button type='button' class='btn btn-default disabled'>Assign New Batch</button></div><div class='btn-group' role='group'><button type='button' class='btn btn-default disabled'>Message Faculty</button></div><div class='btn-group' role='group'><button type='button' class='btn btn-default disabled'>Delete</button></div></div>";
  ...
  showAddBatchModal: function(){
    ...
    "<div class='row' style='margin-top:24px;'><div class='col-xs-12'><b>batch</b>: <input id='year' class='required' type='text' maxlength='4' size='4' autofocus> <span class='showRequiredError glyphicon glyphicon-asterisk' style='color:grey;font-size:12px'></span><br>(batch should be ending year for the batch. ex: if batch ending in year 2014, then '2014')</div><div class='col-xs-12' style='margin-top:10px;'><b>class</b>: " + stri + "</div><div class='col-xs-12' style='margin-top:10px;'><b>Section</b>: <input id='section' class='required' type='text' maxlength='4' size='4'> <span class='showRequiredError glyphicon glyphicon-asterisk' style='color:grey;font-size:12px'></span></div><div class='col-xs-4 col-xs-offset-5' style='margin-top:10px;'><input type='file' style='border-bottom:none;margin-top:10px;' accept='text/plain' name='student_list' id='student_list'></div><br></div></div><div class='col-xs-1 close' style='font-size:40px;font-weight:bold;cursor:pointer;padding:0px;' onclick='view.closeAddBatchModal()'>&times;</div></div><div class='row'><div type=button style='margin-top:25px;' class='col-xs-2 col-xs-offset-5'><button class=' btn btn-danger' onclick='controller.checkAll(1)'>Send</button></div></div></div>";
  ...
  showClassData: function(){
     ...
     exams += "</div></div></div>";
      if(model.selectedBatch.current_faculties.length != 0){
        ...
        subjects += "</div></div></div>";
         ...
         left = "<div class='col-xs-9' style='height:500px;overflow-y:auto;padding-right:75px;'><div class='row' id='classStudentData' style='margin-top:35px'></div></div>";
      } else {
    ...
    var header_options = "<div class='col-xs-8 text-center' style='position:fixed;top:15px;right:120px;z-index:1;'><div class='btn btn-group btn-group-justified' role='group' aria-label='...'>" + "<div class='btn-group' role='group'><div class='dropdown'><button type='button' class='btn btn-default drpdnbtn' onclick='view.dropdown(event)' tg='batch#new' style='padding-top:10px;padding-bottom:10px'>New <span class='caret'></span></button><div id='batch#new' class='dropdown-content'><div onclick='view.assignNewSubject()'>Subject</div><div onclick='view.customMessagesModal()'>Test Score</div><div onclick='view.batchOptions(event)' id='addNewStudent'>Student</div></div></div></div><div class='btn-group' role='group'><button type='button' class='btn btn-default' onclick='view.batchOptions(event)' id='takeAttendance' style='padding-top:10px;padding-bottom:10px'>Take Attendance</button></div>" + "<div class='btn-group' role='group'><button type='button' class='btn btn-default' onclick='view.messageWholeClassModal()' style='padding-top:10px;padding-bottom:10px'>Message</button></div>" +"<div class='btn-group' role='group'><div class='dropdown'><button type='button' class='btn btn-default drpdnbtn' onclick='view.dropdown(event)' tg='batch#options' style='padding-top:10px;padding-bottom:10px'>Options <span class='caret'></span></button><div id='batch#options' class='dropdown-content'>" + "<div onclick='view.setSchedule()'>Set Schedule</div>" + "</div></div></div></div></div><div class='glyphicon glyphicon-arrow-left' style='position:fixed;right:20px;top:15px;padding:10px;background-color:white;border-radius:3px;border:solid 1px rgba(160,160,160,.8);box-shadow:1px 2px 5px rgba(160,160,160,.8);font-size:20px;color:rgb(70,70,70);cursor:pointer' onclick='view.showClasses()'></div>";
  ...
  notifyUser: function(str,a){
    ...
    document.getElementsByTagName('body')[0].innerHTML += "<div id='notifyUser' class='notif-modal'><div class='text-center' style='position:fixed;right:50px;top:60px;'><div style='border:solid 1px rgba(110,110,110,.6);border-radius:5px;opacity:.8;border-radius:3px;padding:15px;z-index:10' id='notifText'></div></div></div><div id='notifyError' class='modal'><div class='text-center' style='position:fixed;right:25px;top:120px'><div style='border:solid 1px rgba(110,110,110,.6);border-radius:5px;opacity:.8;border-radius:3px;padding:15px' id='notifText2'></div></div></div>";
  ...
  messageWholeClassModal: function(){
    ...
    document.getElementsByTagName('body')[0].innerHTML += "<div class='text-center col-xs-12 modal' id='messageClassModal' style='animation-name:modalDrop;animation-duration:.3s'><div class='row' style='margin-top:50px'><div class='col-xs-8 col-xs-offset-2' class='name_selection' style='background-color:white;border-radius:3px;padding-top:20px;padding-bottom:20px'><div class='row'><div class='col-xs-4' style='border-right: solid 1px rgba(200,200,200,1);'><div class='row' style='padding-top:10px;padding-bottom:10px;'><div class='col-xs-8 col-xs-offset-2' style='border-bottom:solid 1px rgba(200,200,200,.6);'><div class='row'><div class='col-xs-4 text-right'><input type='checkbox' name='selectAll' value='true' onclick='view.selectAll()'></div><div class='col-xs-8 text-left' style='color:rgb(110,110,110);font-size:18px;'>Select All</div></div></div></div><div id='names_list' class='row' style='height:250px;overflow-y:auto;padding-left:10px;padding-right:10px;margin-top:15px'>" + names + "</div></div><div class='col-xs-4' style='border-right: solid 1px rgba(200,200,200,1);'><div class='row' style='padding-top:10px;padding-bottom:10px;'><div class='col-xs-8 col-xs-offset-2' style='color:rgb(110,110,110);'><div class='row'><div class='col-xs-12' style='font-size:18px;border-bottom:solid 1px rgba(200,200,200,.6);'>Selected</div></div></div></div><div class='row' style='padding-top:15px'><div class='col-xs-8 col-xs-offset-2' id='selectedNames' style='height:250px;overflow-y:auto;'></div></div></div><div class='col-xs-4'><div class='row' style='padding-top:10px;padding-bottom:10px;'><div class='col-xs-8 col-xs-offset-2' style='color:rgb(110,110,110);'><div class='row'><div class='col-xs-12' style='font-size:18px;border-bottom:solid 1px rgba(200,200,200,.6);'>Text</div></div></div></div><div class='row' style='padding-top:15px'><div class='col-xs-8 col-xs-offset-2'><textarea id='SMSclasstext' placeholder='Enter Text Message' rows=10 cols=15 maxlength=160 style='border-radius:5px;' autofocus></textarea></div></div></div></div></div><div class='col-xs-1' style='font-size:28px;margin-left:20px;color:white;cursor:pointer' onclick='view.closeMessageClassModal()'><span class='glyphicon glyphicon-remove close'></span></div></div><div class='row' style='margin-top:50px'><button class='col-xs-2 col-xs-offset-5' style='background-color:rgb(30, 90, 188);padding-top:10px;padding-bottom:10px;border-radius:2px;font-size:18px;color:white;border:solid 1px rgba(90,90,90,.8);cursor:pointer;border:solid 1px rgb(239, 166, 33)' onclick='controller.sendSMStoClass()'>Send</button></div></div>";
...
showStudent: function(){
  ...
  for(let p in so){
    initials += "<div class='row student_data_tabs'><div class='col-xs-12'>" + so[p] + "</div><div class='col-xs-12'>" + model.selectedStudent[p] + "</div></div>";
  }
  let mobiles = ""
  let mo = {
    parent1: "Parent's no.1",
    parent2: "Parent's no.2",
    student: "Students's no.",
    other: "Other",
  }
  for(let p in mo){
    if(model.selectedStudent.mobiles.hasOwnProperty(p)){
      mobiles += "<div class='row mobiles'><div class='col-xs-10 col-xs-offset-1'>" + mo[p] + "</div><div class='col-xs-10 col-xs-offset-1'>" + model.selectedStudent.mobiles[p] + "</div></div>"
    }
  }

  document.getElementById('student_personal_info').innerHTML += initials + "<div class='row' style='padding-top:5px;padding-bottom:5px;margin-top:5px;margin-bottom:5px;font-weight:bold;color:rgb(130,130,130)'><div class='col-xs-12'>contact</div></div><div class='row student_data_tabs'><div class='col-xs-12 all_mobiles'>" + mobiles + "</div></div><div class='row' style='padding:5px'><div class='col-xs-12' style='padding-top:5px'><div class='row'><div class='col-xs-12 btn btn-primary' style='border-radius:2px;font-weight:normal'>Message</div></div></div></div>";
...
showSelectedSubjectData: function(e){
  model.selectedStudent.selectedSubject = e.target.id;
    ...
    document.getElementById('student_detail_section').innerHTML = "<div class='row' style='padding-top:20px;padding-bottom:20px'><div class='col-xs-10 col-xs-offset-1'><div class='row'><div class='col-xs-12' style='border-bottom: solid 1px rgb(200,200,200);color:rgb(110,110,110)'><h3>Past 10 Exams</h3></div></div></div>";
...
document.getElementById("batchOptions").style.display = "block" ;
    ...
    case "takeAttendance":
      window.open("http://localhost:80/admin/takeattendance/all","_blank");
      break;
  }
},
...
closeScheduleModal: function(){
  ...
  document.getElementById("scheduleModal").parentNode.removeChild(document.getElementById("scheduleModal"));
  controller.sectionData();
},

closeAddImageModal: function(){
  document.getElementById("addImage").style.display = "none" ;
  document.getElementById("addImage").parentNode.removeChild(document.getElementById("addImage"));
  controller.getStudentData(model.xe);
},
...
addImage: function(){
    let content = "<div class='row' style='padding-top:40px;padding-bottom:40px;'><div class='col-xs-6 text-right' style='padding-top:10px'><b>Student's Image</b>( .jpg/.jpeg )<br><span id='fileErr' style='display:none;color:red'>File size should be less than 100KB</span><span id='fileErr2' style='display:none;color:red'>Select A File</span></div><div class='col-xs-6 text-center'><input type='file' class='required' width='10' accept='.jpg,.jpeg' id='file' name='image'></div></div>";
    document.getElementsByTagName("body")[0].innerHTML += "<div id='addImage' class='text-center modal col-sm-12' style='padding-top:50px'><div class='row'><div class='col-sm-6 col-sm-offset-3 modalContent'><div class='row modelHeader' style='border-bottom: solid 1px rgba(160,160,160,.6)'><div class='col-sm-12'><h2>Add Student's Image</h2></div></div>" + content + "</div><div class='col-xs-1 close' style='font-size:40px;font-weight:bold;cursor:pointer;padding:0px;' onclick='view.closeAddImageModal()'>&times;</div></div><div class='row' style='margin-top:15px;'><div class='col-xs-2 col-xs-offset-5'><button class='btn btn-danger' onclick='controller.checkAll(3)'>Done</button></div></div></div>";
